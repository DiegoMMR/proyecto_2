...
if (isset($_POST['datos_registrar_usuario']) and isset($_POST['datos_registrar_contraseña'])){
    ...
    $contraseña=password_hash($_POST['datos_registrar_contraseña'],PASSWORD_DEFAULT);//hashea el password
    $ingresar=mysqli_query($conexion,'insert into usuarios(columna_usuario,columna_password) values
